...
![攻略详情](assets/screenshots/detail.png)

---

### 🤖 AI 智能助手

![AI助手](assets/screenshots/ai-chat.png)

---

### 🗺️ 路线规划

![路线规划](assets/screenshots/route-map.png)

---

### 👤 个人主页

![个人主页](assets/screenshots/profile.png)

---

### 🔍 地点搜索

![地点搜索](assets/screenshots/location-search.png)
...
│                      Frontend (Vue 3)                        │
├──────────────────────────────────────────────────────────────┤
│  Vite 7.x  │  Ant Design Vue 4.x  │  Pinia  │  Vue Router   │
├──────────────────────────────────────────────────────────────┤
│                     Axios + OpenAPI                          │
├──────────────────────────────────────────────────────────────┤
│                  WebSocket（实时通知推送）                    │
...
│                   Backend (Spring Boot)                      │
├──────────────────────────────────────────────────────────────┤
│ Controller │ Service │ MyBatis-Flex │ AOP(AuthCheck)         │
├──────────────────────────────────────────────────────────────┤
│ LangChain4j + DeepSeek │ WebSocket │ CosManager (COS)       │
└──────────────────────────────────────────────────────────────┘

                            ↓

┌───────────────────────────┬──────────────────────────────────┐
│      MySQL（数据持久化）    │ Redis（Session + AI聊天记忆）    │
└───────────────────────────┴──────────────────────────────────┘
```
